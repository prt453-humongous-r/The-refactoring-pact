public class TableBuilderDemo {
    ...
    /**
     * Setting a single interface for the builder
     */
    interface Builder {
    ...
    /**
     * Changed our convertor to table director
     * This makes sure we support all type of convertor
     * through builder iniation
     */
    class TableDirector {
